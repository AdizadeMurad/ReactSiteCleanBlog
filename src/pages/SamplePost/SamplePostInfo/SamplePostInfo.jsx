...
function SamplePostInfo() {
  return (
    <>
      <section className="texts__sampleP">
        <div className="text__general__sampleP">
          <div className="text__about__sampleP">
            <p className="text__middle__sampleP">
        ...
        <div className="text__general__sampleP">
          <div className="text__about__sampleP">
            <p className="text__head__sampleP">The Final Frontier</p>
          ...
          <div className="text__about__sampleP">
            <p className="text__middle__sampleP__dream">
        ...
        <div className="text__general__sampleP">
          <div className="text__about__sampleP">
            <p className="text__head__sampleP">Reaching for the Stars</p>
          ...
          <div className="text__about__sampleP">
            <img
              className="sampleP__photo"
              src="/public/imgs/post-sample-image.jpg"
              alt=""
            />
          ...
          <div className="text__about__sampleP">
            <p className="text__middle__sampleP">
              Placeholder text by{" "}
              <span className="bottom__tag">Space Ipsum</span> · Images by{" "}
              <span className="bottom__tag">NASA on The Commons</span>
            </p>
          </div>
        </div>
      </section>
